...
<div class="profil">
  <h5>Prénom :</h5> <?php if (isset($_SESSION['firstName'])) {
                      echo '<h5>' . $_SESSION['firstName'] . '</h5>';
                    } ?>
</div>
<div class="profil">
  <h5>Nom :</h5> <?php if (isset($_SESSION['lastName'])) {
                    echo '<h5>' . $_SESSION['lastName'] . '</h5>';
                  } ?>
</div>
<div class="profil">
...
<body>
  ...
  <div class="blue">
    ...
    $reponse = $conn->prepare('SELECT * FROM employe WHERE etat=1 ORDER BY ID ASC LIMIT :debut, :limite ');
